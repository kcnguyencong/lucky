...
class LotteryScraper {
     ...
     */
    async runScrape(lotteryType = 'MEGA_645') {
        try {
            const html = await this.fetchWithRetry(this.config.targetUrl);
            const parsedResults = parser_1.DrawParser.parseHTML(html, lotteryType);
        ...
        return parser_1.DrawParser.generateMockDrawHistory(lotteryType, 60);
    }
}
exports.LotteryScraper = LotteryScraper;
