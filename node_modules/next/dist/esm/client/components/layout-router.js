...
import { InstantValidationBoundaryContext, RenderValidationBoundaryAtThisLevel } from './instant-validation/boundary';
 ...
 */ function getScrollTargetState(instance, viewportHeight) {
    ...
    return elementTop >= 0 && elementTop <= viewportHeight ? 1 : 2;
}
/**
    ...
    constructor(...args){
        super(...args), this.handlePotentialScroll = ()=>{
            ...
            disableSmoothScrollDuringRouteTransition(()=>{
                ...
                if (getScrollTargetState(domNode, viewportHeight) === 1) {
                    return;
                }
 ...
 */ function InnerScrollHandlerNew(props) {
    ...
    useLayoutEffect(()=>{
        ...
        disableSmoothScrollDuringRouteTransition(()=>{
            ...
            htmlElement.scrollTop = 0;
            // Scroll to domNode if domNode is not in viewport when scrolled to top of document
            if (getScrollTargetState(instance, viewportHeight) === 2) {
                // Scroll into view doesn't scroll horizontally by default when not needed
                instance.scrollIntoView();
            }
        }, {
