import { PrefetchHint, propagateSubtreeBits } from '../../shared/lib/app-router-types';
...
async function createFlightRouterStateFromLoaderTreeImpl(loaderTree, hintTree, prefetchInliningEnabled, cacheComponents, partialPrefetching, isStaticGeneration, isBuildTimePrerendering, getDynamicParamFromSegment, searchParams, didFindRootLayout) {
    ...
    const isInstant = instantConfig === true || typeof instantConfig === 'object' && instantConfig !== null;
    if (isInstant) {
    ...
    if (prefetchConfig === 'partial') {
        ...
        // shared app shell.
        prefetchHints |= PrefetchHint.SubtreeHasPartialPrefetching | PrefetchHint.SubtreeHasEagerPrefetch;
...
export async function createFlightRouterStateFromLoaderTree(loaderTree, hintTree, prefetchInliningEnabled, cacheComponents, partialPrefetching, isStaticGeneration, isBuildTimePrerendering, getDynamicParamFromSegment, searchParams, // Whether a root layout was already found above this loader tree slice, so a
...
export async function createRouteTreePrefetch(loaderTree, hintTree, prefetchInliningEnabled, cacheComponents, partialPrefetching, isStaticGeneration, isBuildTimePrerendering, getDynamicParamFromSegment, // See note on createFlightRouterStateFromLoaderTree's didFindRootLayout.
didFindRootLayout = false) {
